...
export const Cuartel = ({ setBombero, bomberos,
    setBrowser, setBusqueda, usuario,
    handleBusqueda, browser, busqueda, handleChange, bombero,
    idCuartel, nombreCuartel }) => {

    return (
        <>
            <Container style={{ opacity: '100' }}>
                <h2>Listado bomberos en servicio <b> {nombreCuartel}</b></h2>
                        ...
                        <div className="content">
                            <div className="cuerpo">
                                <div className="cards mr-4">
                                    {bomberos?.map((bombero) => {
                                        if (bombero.servicio && bombero.activo && bombero.cuartelServicio?._id === idCuartel) {
                                            return (
                                                <Bombero
                                                    key={bombero._id}
                                                    bombero={bombero}
